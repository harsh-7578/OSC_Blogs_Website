    ...
    <div className="container mt-3">
      <div className="card p-3 mb-3">
        ...
        <div className="mt-3">
          <h3>Info :</h3>
          <ul className="list">
            <li>TechBlogs is a MERN Blogging website.</li>
            <li>
              This is a blogging website where users can create, edit ,delete
              blogs.
            </li>
            <li>
              Users are required to login first inorder to create 
              posts.
            </li>
            <li>
              Frontend is created using React and we have used Bootstrap for
              styling the website.
            </li>
            <li>
              Users can see all the posts on the website but in order to create a post(blog) user needs to login.
            </li>
            <li>
