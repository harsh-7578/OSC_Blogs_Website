    ...
    <div className="container mt-3">
      <div className="card p-3 mb-3 main-body">
        ...
        <div className="mt-3 d-flex mern">
          ...
          <p>
            TechBlogs is a MERN Blogging App. MERN stands for MongoDB, Express,
            React, NodeJS, after the four key technologies that make up the stack.
            <ul>
              <li>MongoDB - document database.</li>
              <li> Express(.js) - Node.js web framework.</li>
              <li>React(.js) - a client-side JavaScript framework.</li>
              <li>Node(.js) - the  JavaScript web server.</li>
            </ul>
          </p>
        </div>
        <div className="mt-3">
